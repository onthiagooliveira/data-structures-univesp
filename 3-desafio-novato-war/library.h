/**
 * @file library.C
 * @brief Biblioteca com funções, seguindo o padrão de modularização | Jogo War
 * @date 2026
*/
...
// Define um alias para o tipo int
typedef int typeInt;
...
/** @brief Função que aloca endereço de memória e zera os campos para inserção dos dados */
int* allocateMemoryTypeInt() {
  int* ptr = (int*) calloc(1, sizeof(int)); // Armazena o endereço devolvido por calloc em ptr
  return ptr;
}
...
void viewMenu() {
  do {
    ...
    // Limpa o buffer a cada interação do usuário
    bufferClearing();
